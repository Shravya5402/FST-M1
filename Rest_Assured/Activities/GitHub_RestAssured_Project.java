...
public class GitHub_RestAssured_Project {
    ...
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKRypXIMHS82FXw+m6pnk+ATYFCTmOHUmnXdzMe7wXMQ azuread\\roopanaik@IBM-PF2R6YFY\r\n";
    int sshKeyId;

    // Request specification
    RequestSpecification requestSpec = new RequestSpecBuilder().
            setBaseUri("https://api.github.com/user/keys").
            addHeader("Authorization", "token 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").
