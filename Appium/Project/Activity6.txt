...
public class Projectactivity6 {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        scrollAndClick(wait, "Popups");
        
        testPopupLogin(wait, "admin", "password", "Welcome Back, admin"); // Correct credentials test
        testPopupLogin(wait, "admin", "wrongpassword", "Invalid Credentials"); // Incorrect credentials test
        
        System.out.println("Popup Login Test Completed!");
        driver.quit();
    }
    ...
    private static void testPopupLogin(WebDriverWait wait, String username, String password, String expectedMessage) {
        MobileElement signInButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[text()='Sign In']")));
        signInButton.click();
